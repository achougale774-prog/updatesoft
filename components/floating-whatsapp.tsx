...
export function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      <div className="absolute right-full mr-3 bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 px-4 py-2 rounded-xl shadow-xl text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none border border-gray-100 dark:border-zinc-800">
        Chat with us
      </div>
      <svg
        viewBox="0 0 24 24"
