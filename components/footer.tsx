        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              ...
              <Link href="https://instagram.com/winsoft" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] p-2.5 rounded-full text-white hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-[#dc2743]/30 group">
